...
public class TwoRobotsShortestPath2 extends ShortestPathAlgorithm {
      public TwoRobotsShortestPath2(ShortestPathData data) {
         super(data);
     }
      ...
      private BinaryHeap<Label> heapInit() {
       ...
       protected ShortestPathSolution doRun() {
         ...
         // ShortestPathData data1 = new ShortestPathData(data.getGraph(), O1, meetingNode, data.getArcInspector());
          ...
          return new ShortestPathSolution(data, Status.FEASIBLE, Path.concatenate(path1, path3));
       }
